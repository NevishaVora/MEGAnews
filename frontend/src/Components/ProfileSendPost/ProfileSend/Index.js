                ...
                <div className='bg-gray-100 rounded-md p-2 mt-6'>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex gap-6 font-medium flex-1 justify-center mt-6'>
                            ...
                            <div onClick={() => handlesendPost()} className='cursor-pointer text-center'>Send Post <div className='bg-red-600 w-[10px] h-[4px] rounded-lg'></div></div>
